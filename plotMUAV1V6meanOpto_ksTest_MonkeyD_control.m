function [stats] = plotMUAV1V6meanOpto_ksTest_MonkeyD_control( fullSessionName, tr, aMU1eS, aMU6eS, preT, postT, xlimPl, Fs, msSmooth)
% plots mean MUA psth across channels and makes ks test to find significantly modulated
% channels for opto control data in MonkeyD
...
%% select valid trials
tr.isSelTrTr = tr.thisLaserSham == 7010 & tr.laserAmp >0 & tr.thisLaserFreq == 80; % use 80Hz sine wave trials as comparison to Monkey A
...
MUAaTrAvrgV6_505nm = squeeze(mean(aMU6eS(tr.thisLaserCond == 7001 & tr.isSelTrTr, :,:))); 
% % baseline subtraction V6
...
ksTrSel = tr.thisLaserCond == 7001 & tr.isSelTrTr;
...
trCondSel(1,:) = tr.isSelTrTr & tr.thisLaserCond == 7001; % blue  % PJ
trCondSel(2,:) = tr.isSelTrTr & tr.thisLaserCond == 7002;  % yellow
