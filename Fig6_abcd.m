...
% %%%% Examples for paper:
% cfg.sessionID = 564;
% cfg.cluIDList = [20 70 195 122 ];
% cfg.stimTime = 0.65; 

% %% Anno OPTO:
% cfg.sessionID = 475;   
% cfg.cluIDList = [145 184 216];
% cfg.stimTime = 0.250; 
% epocType = 'laserOn';
% xlimPSTH = [-0.2 cfg.stimTime+0.2];

% %% Andolf OPTO:
% cfg.sessionID = 20575;   
% cfg.cluIDList = [97 243];
% cfg.stimTime = 0.250; 
% epocType = 'laserOn';
% xlimPSTH = [-0.2 cfg.stimTime+0.2];
...
%% epoch cluster data
if ~exist('epocType', 'var')
epocType = 'stimOnTphot';
end
% epocType = 'pulsePeakT'; 
% epocType = 'laserOn';
...
%% Orientation tuning plot as inset

% data time for orientation tuning
startBinT = 0; 
endBinT = cfg.stimTime; 

try
[ahOri] = oriTuningSubplot(tr, clu, iCluInd, trSel_yell, startBinT, endBinT);
catch
    disp('Could not plot orientation tuning!')
end
